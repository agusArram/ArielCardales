package SORT_PROYECTS.AppInventario.service;
...
import SORT_PROYECTS.AppInventario.controller.ProductoTreeController;
...
public class InventarioService {
    ...
    public Optional<ItemInventario> mostrarSelectorProductos(Stage owner) {
        ...
        TreeTableView<ItemInventario> tabla = Arboles.crearTreeTabla(columnas);
