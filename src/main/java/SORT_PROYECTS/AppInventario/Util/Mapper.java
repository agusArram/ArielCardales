...
import SORT_PROYECTS.AppInventario.Entidades.Cliente;
...
public class Mapper {
     ...
     */
    public static Licencia getLicencia(ResultSet rs) throws SQLException {
        ...
        lic.setEstado(Licencia.EstadoLicencia.valueOf(estadoStr));

        // Mapear plan
        String planStr = rs.getString("plan");
        lic.setPlan(Licencia.PlanLicencia.valueOf(planStr));
