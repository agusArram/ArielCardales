package SORT_PROYECTS.AppInventario;
...
public class App extends Application {
    ...
    private void cargarVentanaLogin(Stage stage) throws Exception {
        ...
        stage.setTitle("SORT_PROYECTS - Iniciar Sesión");
    ...
    private void cargarVentanaPrincipal(Stage stage) throws Exception {
        ...
        stage.setScene(scene);
        stage.setTitle("SORT_PROYECTS - " + SessionManager.getInstance().getNombreUsuario());
    ...
    private void mostrarPantallaCarga(Stage stage) throws Exception {
        ...
        stage.setScene(scene);
        stage.setTitle("SORT_PROYECTS - Cargando...");
        stage.setResizable(false);
        stage.centerOnScreen();
        stage.show();
    }
