...
import SORT_PROYECTS.AppInventario.Entidades.Venta;
import SORT_PROYECTS.AppInventario.Entidades.Venta.VentaItem;
...
public class VentasController {
    ...
    private PauseTransition pausaBusquedaCliente = new PauseTransition(Duration.millis(250));
    ...
    private void configurarTablaVentasUnificada() {
        ...
        List<TableColumn<Venta, ?>> cols = Tablas.crearColumnas(columnas);
    ...
    private void configurarFiltros() {
        ...
        // Búsqueda de cliente con debounce (250ms delay)
        txtBuscarCliente.textProperty().addListener((obs, oldVal, newVal) -> {
            pausaBusquedaCliente.stop();
            pausaBusquedaCliente.setOnFinished(e -> {
            ...
            pausaBusquedaCliente.playFromStart();
        });
    }
...
// ===============================================
    ...
    private void anularVentaSeleccionada() {
        ...
        java.util.Optional<ButtonType> resultado = DialogosUtil.confirmarAccion(
            "Anular venta",
