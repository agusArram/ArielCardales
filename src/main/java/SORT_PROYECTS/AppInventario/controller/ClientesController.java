...
import SORT_PROYECTS.AppInventario.DAO.ClienteDAO;
import SORT_PROYECTS.AppInventario.Entidades.Cliente;
import SORT_PROYECTS.AppInventario.Entidades.ItemCliente;
...
public class ClientesController {
    ...
    private void eliminarClienteSeleccionado() {
        ...
        if (!DialogosUtil.confirmarEliminacion("Eliminar cliente", mensaje)) {
            return;
        }
