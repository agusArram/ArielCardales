...
import SORT_PROYECTS.AppInventario.Util.EdicionCeldas;
import SORT_PROYECTS.AppInventario.DAO.*;
import SORT_PROYECTS.AppInventario.Entidades.*;
import SORT_PROYECTS.AppInventario.Util.*;
import SORT_PROYECTS.AppInventario.View.VentanaVenta;
import SORT_PROYECTS.AppInventario.service.InventarioService;
...
// ============================================================================
     ...
     * La validación de "variantes no pueden editar categoría" está en InventarioService
     */
    private void configurarEdicionCategoriaConCache(TreeTableColumn<ItemInventario, String> col, EdicionCeldas editor) {
        // Simplemente delegar al editor - las validaciones están en el Service
...
// ────────────────────────────────────────────────────────────────────────────
    ...
    private void eliminarProducto() {
        ...
        if (item.isEsVariante()) {
            ...
            if (DialogosUtil.confirmarEliminacion("Eliminar variante", mensaje)) {
                try {
        ...
        if (DialogosUtil.confirmarEliminacion("Eliminar producto", mensaje)) {
            try {
