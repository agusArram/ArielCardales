...
// ============================================================================
     ...
     */
    public static javafx.scene.control.TreeItem<com.arielcardales.arielcardales.Entidades.ItemInventario>
    clonarYFiltrarItemInventario(
            javafx.scene.control.TreeItem<com.arielcardales.arielcardales.Entidades.ItemInventario> original,
            String campo,
            String filtro) {

        if (original == null) return null;

        javafx.scene.control.TreeItem<com.arielcardales.arielcardales.Entidades.ItemInventario> copia =
                new javafx.scene.control.TreeItem<>(original.getValue());
        copia.setExpanded(original.isExpanded());

        String filtroLower = filtro.toLowerCase().trim();

        for (javafx.scene.control.TreeItem<com.arielcardales.arielcardales.Entidades.ItemInventario> hijo : original.getChildren()) {
            javafx.scene.control.TreeItem<com.arielcardales.arielcardales.Entidades.ItemInventario> hijoFiltrado =
                    clonarYFiltrarItemInventario(hijo, campo, filtro);

            if (hijoFiltrado != null && !hijoFiltrado.getChildren().isEmpty()) {
                copia.getChildren().add(hijoFiltrado);
            } else if (hijo.getValue() != null) {
                com.arielcardales.arielcardales.Entidades.ItemInventario item = hijo.getValue();
